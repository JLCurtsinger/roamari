...
export const TransportationSection = () => {
  return (
    <section id="transportation" className="py-16 px-4 bg-white dark:bg-gray-900 scroll-mt-16">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Local Transportation</h2>
